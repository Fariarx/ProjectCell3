...
public class UnitFarmerUpgraded : Unit, IUnitOnGround, ISteppingUnit
{
    ...
    {
        var obj = UnityEngine.Object.Instantiate(Globals.unitsPrefubsCombinator.farmerUpgraded, parent);

        obj.name = "Unit UnitFarmerUpgraded";
        obj.layer = 2;
