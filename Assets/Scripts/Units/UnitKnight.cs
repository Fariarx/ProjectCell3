...
public class UnitKnight : Unit, IUnitOnGround, ISteppingUnit
{
    ...
    {
        var obj = UnityEngine.Object.Instantiate(Globals.unitsPrefubsCombinator.knight, parent);

        obj.name = "Unit UnitKnight";
        obj.layer = 2;
