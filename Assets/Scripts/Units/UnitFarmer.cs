...
public class UnitFarmer : Unit, IUnitOnGround, ISteppingUnit
{
    ...
    {
        var obj = UnityEngine.Object.Instantiate(Globals.unitsPrefubsCombinator.farmer, parent); 

        obj.name = "Unit UnitFarmer";
        obj.layer = 2;
